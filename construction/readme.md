...
<h2>RESULT</h2>
This prototype works well and it can be put in a buoy. It important to understand the power our sensor need because we can scale the dimension of the solar panel and of the pendulum from this information
