...
We want to put on parallel the two sources. The first line consist of: the solar panel, a diode who prevent reverse courrent and a TP4056 who control the charge of the batteries,in this order, we connect all with the jumper wires and after this solder all component.<br>
