...
The two source combined provide energy to a battery peak, the battery peak combined three Li-ion battery. This circuit can provide 365 day operational autonomy and this is very important to track any change in the Venice lagoon. <br><pre><code>
 ┌───────────────────────────┐         ┌───────────────────────────┐
