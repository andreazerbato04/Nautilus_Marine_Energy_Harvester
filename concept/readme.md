...
During the initial design phase, we analyzed different source including piezoelectric, benthic microbial fuel cells and triboelcetric nanogenerators. The combination solar panel with electromagnetic pendulum emerge as the only viable candidates for the Venice lagoon characteristics. For the low cost and maintenance in the buoy.
