...
<li><b>Schottky diode 1N5822:</b> prevent the return of the current on the solar pannel with a low voltage drop.</li>
...
<h2>CIRCUIT</h2>
The first thing we want to build is the bridge rectifier. We use four Schottky diodes 1N5822 because we want a low voltage drop ≈ 0,3V. We put two anodes togeter for the DC negative output and two cathodes togeter for the DC positive output, we connect one cathode and one anode for the last two nodes, this is for the positive and negative polarity of the pendulum, as shown in this picture      <br>       
 <br> 
